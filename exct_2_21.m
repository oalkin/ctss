...
% Compute the two parts of the signal from Eqn. (2.146)
y1 = 1-exp(-(t+0.5)/tau);
...
% Graph the output signal, and show the input pulse with dashed
% red lines
plot(0.5*[-3,-1,-1,1,1,3],[0,0,1,1,0,0],'r--',t,y,'b-'); grid;
axis([-3,3,-0.2,1.2]);

...
% Compute the two parts of the signal from Eqns. (2.55) and (2.56)
...
% Graph the output signal, and show the input pulse with dashed red lines
plot(t,y,'b-',0.5*w*[-3,-1,-1,1,1,3],A*[0,0,1,1,0,0],'r--'); grid;
axis([-3,3,-0.2,1.2]);
